...
//-----------------------------------------------------------------------------
MeshHierarchy::MeshHierarchy() : m_pMA( NULL )
{
}
...
//-----------------------------------------------------------------------------
HRESULT MeshHierarchy::SetMA( THIS_ AnimationContainer *pMA )
{
	m_pMA = pMA;
...
//-----------------------------------------------------------------------------
HRESULT MeshHierarchy::CreateFrame(THIS_ LPCSTR Name, LPD3DXFRAME *ppFrame)
{
	assert( m_pMA );
...
//-----------------------------------------------------------------------------
HRESULT MeshHierarchy::CreateMeshContainer( THIS_
	LPCSTR Name,
	...
	LPD3DXMESHCONTAINER *ppNewMeshContainer )
{
	...
	* ppNewMeshContainer = NULL;
	...
	AnimationMeshContainer * pMC = new AnimationMeshContainer;
	if( pMC == NULL )
	{ hr = E_OUTOFMEMORY; goto e_Exit; }

	ZeroMemory( pMC, sizeof( AnimationMeshContainer ) );
...
//-----------------------------------------------------------------------------
HRESULT MeshHierarchy::DestroyFrame( THIS_ LPD3DXFRAME pFrameToFree )
{
	assert( m_pMA );
...
//-----------------------------------------------------------------------------
HRESULT MeshHierarchy::DestroyMeshContainer( THIS_ LPD3DXMESHCONTAINER pMeshContainerToFree )
{
	assert( m_pMA );

	AnimationMeshContainer * pMC = ( AnimationMeshContainer * ) pMeshContainerToFree;
